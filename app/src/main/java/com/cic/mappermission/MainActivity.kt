...
class MainActivity : AppCompatActivity(), OnMapReadyCallback, View.OnClickListener, LocationListener {
    ...
    override fun onClick(view: View) {
        ...
        val latitud = findViewById<View>(R.id.latitud) as TextView
        val longitud = findViewById<View>(R.id.longitud) as TextView
        latitud.text = "Latitud: " + df.format(latitude)
        longitud.text = "Longitud: " + df.format(longitude)

        val intent = Intent(this, ServiceCSV::class.java)
        intent.putExtra("coord", "$latitude,$longitude")
        startService(intent)
    }
